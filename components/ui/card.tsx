...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-4 rounded-lg border border-border/50 p-5 shadow-sm transition-all duration-200 hover:border-border hover:shadow-md",
        className
      )}
      {...props}
    />
